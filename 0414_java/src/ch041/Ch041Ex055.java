...
/*
		...
		int [] iArr = {7, 11, 34, 20, 16, 14};//i=1; k=5; 16과 11 비교
		...
		int [] iArr = {7, 11, 14, 20, 34, 16};//i=3; k=5; 20과 16 비교
...
*/
		...
		System.out.println("tostring : " + Arrays.toString(iArr2));
		Arrays.sort(iArr2);
		...
		//array + OOP 설계방법론 -> set, Map, List 
		//set, Map, List - 기본자료저장구조 - HashSet, HashMap, ArrayList
