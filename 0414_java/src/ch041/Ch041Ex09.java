...
public class Ch041Ex09 {
	...
	public static void main(String[] args) {
		...
		//same data type 
			...
			dArr[2] = 2100000000; //자동 형태 변경 : data type casting : auto data type casting (묵시적 형변환)
			dArr[3] = 'A'; //ascii code : 자판 신호를 정수로 받는다. 
			//dArr[4] = true; //error
			
			int [] iArr = new int [7];
			//iArr[0] = 3.14; //error // 강제 data 형태 변경 하면 넣을 수 있다.(data 손실 발생 가능) 
			//iArr[1] = 21000000000L;//error // 강제 data 형태 변경 하면 넣을 수 있다.(data 손실 발생 가능) 
			iArr[2] = 'a';//ascii code : 자판 신호를 정수로 받는다.
			//iArr[3] = false; //error 
